...
(function () {
  ...
  function injectStyles() {
    ...
    style.id = 'globalHeaderStyles';
    style.textContent = '' +
      '.global-header{position:sticky;top:0;z-index:1100;background:rgba(255,255,255,.88);backdrop-filter:blur(14px);border-bottom:1px solid rgba(15,111,255,.14);}' +
      ...
      '.global-header__brand:before{content:"";position:absolute;left:0;top:50%;width:.55rem;height:.55rem;border-radius:999px;background:linear-gradient(140deg,#0f6fff,#ff7a18);transform:translateY(-50%);}' +
      '.global-header__nav{display:flex;gap:.4rem;flex-wrap:wrap;}' +
      '.global-header__nav a{padding:.45rem .78rem;border-radius:999px;text-decoration:none;color:#1f3557;font-weight:700;font-size:.89rem;display:inline-flex;align-items:center;gap:.35rem;}' +
      '.global-header__nav a:before{content:"";width:.35rem;height:.35rem;border-radius:999px;background:#bfdbfe;}' +
      '.global-header__nav a.active{background:#dbeafe;color:#0f4fd8;}' +
      '.global-header__nav a.active:before{background:#0f6fff;}' +
      '.global-header__actions{display:flex;gap:.45rem;flex-wrap:wrap;}' +
      ...
      'body.dark-mode .global-header{background:rgba(8,16,32,.88);border-color:rgba(99,164,255,.24);}' +
      ...
      'body.dark-mode .global-header__nav a:before{background:#32507c;}' +
      'body.dark-mode .global-header__nav a.active{background:#1a2f4d;color:#bfdbfe;}' +
      'body.dark-mode .global-header__nav a.active:before{background:#63a4ff;}' +
